...
var s_account="hearstsfgate"
var s=s_gi(s_account)
s.debugTracking=false
s.charSet = "UTF-8"

var s_hdn = s; // Object passed by reference to a more unique variable name

// Site-level variables

var s_mainDomain="http://www.sfgate.com/";
...
s.linkInternalFilters="javascript:,sfgate.com,bloomberg.com,bleacherreport.com,coupons.com,earbits.com,greatschools.org,houzz.com,kaango.com,landsofamerica.com,legacy.com,legalnotice.org,monster.com,loopnet.com,sfgaterealestate.mobi,newhomesource.com,opentable.com,pictopia.com,pointslocal.com,teachstreet.com,wunderground.com,zap2it.com,imomentous.com";
...
function s_doPlugins(s) {
	...
	/* Set Page View Event */
    s.events=s.apl(s.events,'event16',',',16)
  ...
  s.eVar17=s.prop17=s.TimeParting('h','-5'); // Set hour 
  s.eVar18=s.prop18=s.TimeParting('d','-5'); // Set day 
  s.eVar19=s.prop19=s.TimeParting('w','-5'); // Set weekday v. Weekend
  ...
  *********************/
  ...
  if(s.prop28&&!s.eVar29) s.eVar29=s.prop28;
  if(s.prop27&&!s.eVar30) s.eVar30=s.prop27;
  
	/* formAnalysis */
  s.setupFormAnalysis();
  
  /* Plugin Example: setupLinkTrack 2.0.4 */
...
+ ":o.parentNode;if(!o||typeof o=='undefined')return '';y=s.ot(o);if(y"
+ "=='BODY') return '';n=s.oid(o);}for(i=0;i<4;i++){var ltp=setTimeout"
+ "(function(){},10);if(o.tagName.toLowerCase()=='body') return '';if(o"
...
s._IL = new Function("a", "var s=this;return typeof a!='undefined'?a.len"
+ "gth:0");
...
// Change content type for searches to search
if(awControllerName=='search'||s.getQueryParam('action')=='search'){ 
	awOmniContentType='search';
}
...
if (awBoolIs404) {
    ...
    if (typeof omni_originalSource != 'undefined') {
        if (omni_originalSource == 'prweb') {
            s.server = 'prweb';
        }
    }
...
s.setTagContainer("SFGateMain_s");
