...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.viafoura.com";
...
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "232";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "ldakfookijjkhgdcfafk";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.viafoura.com";
...
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "169977599803522";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.viafoura.com";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('2014.WID.1.99.2_widgets_369');
    return path;
}
