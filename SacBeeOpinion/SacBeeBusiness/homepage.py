...
def get_main_stories(dictionary, soup): 
    ...
    for i in soup.find('div', attrs = {"id" : "left_column"}).find_all('div', attrs = {"class":"story lingo_region"}):
        if i.find('a'):
            dictionary["Main Stories"].append(urljoin("http://www.sacbee.com/business/", i.find('a')['href']))  
...
#Original Test Code - Use for Debugging
...
if __name__ == "__main__":
    ...
    scraper.scrape("http://www.sacbee.com/business/", "Sacramento Bee Business", "sacbee_business", get_links)