...
if (!cX.library) {
    cX.library = {
        ...
        addExternalId: function(params) {
            if (this.m_externalUserIds.length < 5) {
        ...
        sendPageViewEvent: function(args) {
            ...
            if (this.m_previousPageViewReport !== pageView) {
                ...
                if (document.images) {
                    ...
                    for (var j = 0; j < this.m_externalUserIds.length; j++) {
                        try {
                            repSrc += '&eid' + j + '=' + encodeURIComponent('' + this.m_externalUserIds[j].id);
                            repSrc += '&eit' + j + '=' + encodeURIComponent('' + this.m_externalUserIds[j].type);
                        } catch (e) { }
                    }
