/* Copyright 2000-2007 Clickability Inc.  */
...
/*Functions*/
function ST (title, url) {
var commonLoc="&fb=Y&url="+escape(url)+"&title="+escape(title)+"&random="+Math.random()+"&partnerID="+partnerID+"&expire="+escape(getClickExpire());
...
function drawBtn(type,text) {
    ...
    if (stT) {
        ...
        bLay[i]+="<A HREF=\"#\" ONCLICK=\"return(ST(title, url));\" onMouseOver=\"return(STMouseOver());\" onMouseOut=\"return(STMouseOut());\">";
    ...
    if (etT) {
        if (type=='v') bLay[i]+="<div>";
        bLay[i]+="<A HREF=\"#\" ONCLICK=\"return(ET(title, url));\" onMouseOver=\"return(ETMouseOver());\" onMouseOut=\"return(ETMouseOut());\">";
    ...
    if (ptT) {
        if (type=='v') bLay[i]+="<div>";
        bLay[i]+="<A HREF=\"#\" ONCLICK=\"return(PT(title, url));\" onMouseOver=\"return(PTMouseOver());\" onMouseOut=\"return(PTMouseOut());\">";
