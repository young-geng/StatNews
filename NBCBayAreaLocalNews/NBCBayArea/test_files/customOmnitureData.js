...
NBCUOmniture.version = "1.0.130502.0";
...
console.log("**** NBC OTS  + CYPRESS | NBCUOmniture._removeAllListeners START ****");
}
...
if ( navigator.userAgent.match(/like Mac OS X/i) ) {
console.log("**** NBC OTS  + CYPRESS | NBCUOmniture._removeAllListeners END****");
}
};
...
if ( navigator.userAgent.match(/like Mac OS X/i) ) {
console.log("**** NBC OTS  + CYPRESS | NBCUOmniture.initialize START ****");
console.log("**** STATUS OF nbcu OBJECT:"+ typeof nbcu + " ****");
}
...
if ( navigator.userAgent.match(/like Mac OS X/i) ) {
console.log("**** NBC OTS  + CYPRESS | NBCUOmniture.initialize END ****");
}
